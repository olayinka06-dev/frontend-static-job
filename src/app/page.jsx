...
import { Header } from "@/components/staticjob/Header"; 
  ...
  return (
    <section className="bg-primary w-full min-h-screen">
      ...
      <div className="flex flex-col text-main gap-2 py-2 text-center">
        ...
        <span>Follow and Give it a Star on <button className="inline-flex text-white bg-main border-0 py-2 px-6 focus:outline-none hover:opacity-[70%] rounded text-lg">
            GitHub
        </button></span>
      </div>
    </section>
